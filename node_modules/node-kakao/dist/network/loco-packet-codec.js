...
(function (factory) {
    ...
    exports.LocoPacketCodec = void 0;
    ...
    class LocoPacketCodec {
        ...
        async read() {
            const headerArray = await stream_1.ReadStreamUtil.exact(this._stream, 22);
            if (!headerArray)
                return;
            ...
            const data = await stream_1.ReadStreamUtil.exact(this._stream, dataSize);
            if (!data)
                return;
            return {
                header: header,
    ...
    exports.LocoPacketCodec = LocoPacketCodec;
});
