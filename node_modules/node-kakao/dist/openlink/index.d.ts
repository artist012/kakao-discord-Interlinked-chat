 ...
 */
export interface OpenLink extends OpenLinkSettings, OpenLinkComponent, OpenTokenComponent, OpenPrivilegeComponent {
    /**
     * Link type
     */
    type: OpenLinkType;
...
export declare enum KnownLinkPrivilegeMask {
    URL_SHARABLE = 2,
    REPORTABLE = 4,
    PROFILE_EDITABLE = 8,
