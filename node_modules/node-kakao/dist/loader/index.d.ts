...
export interface ClientDataLoader {
    ...
    loadNormalChannelStore(channel: Channel, lastUpdate?: number): AsyncClientDataLoadResult<UpdatableChannelDataStore<NormalChannelInfo, NormalChannelUserInfo>>;
    loadOpenChannelStore(channel: OpenChannel, lastUpdate?: number): AsyncClientDataLoadResult<UpdatableChannelDataStore<OpenChannelInfo, OpenChannelUserInfo>>;
}
